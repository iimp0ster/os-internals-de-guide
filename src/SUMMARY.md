...
- [Execution graphs](execution/00-intro.md)
...
- [Persistence graphs](persistence/00-intro.md)
  - [Service & daemon persistence](persistence/01-service-daemon.md)
  - [Scheduled execution](persistence/02-scheduled.md)
    - [Windows Task Scheduler](persistence/scheduled/windows-task-scheduler.md)
...
- [Privilege and access graphs](privilege-escalation/00-intro.md)
...
- [Defense-evasion graphs](defense-evasion/00-intro.md)
