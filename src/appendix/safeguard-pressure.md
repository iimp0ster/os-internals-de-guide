...
reporting, as-of **mid-2026**. **Safeguard defaults are version- and edition-specific**, treat "default-on since version X" as vendor-documented as-of this snapshot, and re-check
...
```admonish bug title="Observation bias is not absence"
