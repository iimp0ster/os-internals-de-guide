...
> **Translation cue.** Treat this as a macOS-specific evidence card, not a promise that every
> macOS endpoint has this telemetry. Pair it with the Foundation pages on
> [process and loader behavior](../foundations/02-process-and-loader-behavior.md) and
> [filesystem and staging](../foundations/01-filesystem-and-staging.md) to compare the same
> evidence question across Windows, Linux, and macOS.
